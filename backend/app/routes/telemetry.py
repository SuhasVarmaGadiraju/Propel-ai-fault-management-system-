...
logger = logging.getLogger("telemetry_routes")
...
def ingest_telemetry_single():
    ...
    try:
        ...
        logger.error(f"POST /api/v1/telemetry failed: {e}\n{tb}")
        print("\n" + "=" * 80)
        print("POST /api/v1/telemetry FAILED")
        print(tb)
        print("=" * 80 + "\n")
...
def ingest_telemetry_bulk():
    ...
    try:
        ...
        tb = traceback.format_exc()
        logger.error(f"POST /api/v1/telemetry/bulk failed: {e}\n{tb}")
        print("\n" + "=" * 80)
        print("POST /api/v1/telemetry/bulk FAILED")
        print(tb)
        print("=" * 80 + "\n")
        return jsonify({"error": {"code": 500, "name": "Internal Server Error", "description": str(e), "traceback": tb}}), 500
...
def get_telemetry_statistics():
    ...
    try:
        ...
        tb = traceback.format_exc()
        logger.error(f"GET /api/v1/telemetry/statistics failed: {e}\n{tb}")
        print("\n" + "=" * 80)
        print("GET /api/v1/telemetry/statistics FAILED")
        print(tb)
        print("=" * 80 + "\n")
        return jsonify({"error": {"code": 500, "name": "Internal Server Error", "description": str(e), "traceback": tb}}), 500
...
def list_telemetry():
    ...
    try:
        ...
        tb = traceback.format_exc()
        logger.error(f"GET /api/v1/telemetry failed: {e}\n{tb}")
        print("\n" + "=" * 80)
        print("GET /api/v1/telemetry FAILED")
        print(tb)
        print("=" * 80 + "\n")
        return jsonify({"error": {"code": 500, "name": "Internal Server Error", "description": str(e), "traceback": tb}}), 500
